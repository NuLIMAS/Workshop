...
const Foam::scalar Foam::interfaceFront::positionDifference_ = 1e-8;

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::interfaceFront::modifyInterface
(
    polyTopoChange& ref
) const
{
    ...
    if (debug)
    {
        Pout<< "void interfaceFront::addInterface("
...
void Foam::interfaceFront::modifyMotionPoints
(
...
) const
{
    ...
    if (debug)
    {
        Pout<< "void interfaceFront::modifyMotionPoints("
