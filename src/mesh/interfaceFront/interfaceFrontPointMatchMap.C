...
Foam::interfaceFront::pointMatchMap() const
{
...
void Foam::interfaceFront::calcPointMatchMap() const
{
    if (debug)
    {
        Pout<< "void interfaceFront::calcPointMatchMap() const "
            << " for object " << name() << " : "
    ...
    if (pointMatchMapPtr_)
    {
        FatalErrorIn
        (
            "void interfaceFront::calcPointMatchMap() const"
