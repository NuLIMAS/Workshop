...
#include "rockingMotionFvPatchScalarField.H"
...
Foam::rockingMotionFvPatchScalarField::
rockingMotionFvPatchScalarField
(
    const fvPatch& p,
...
rockingMotionFvPatchScalarField
(
    const rockingMotionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::rockingMotionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::rockingMotionFvPatchScalarField::write
(
    Ostream& os
) const
{
